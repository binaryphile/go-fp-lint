...
#
# journal.bash — the crash-safe, exactly-once per-slot journal, forked
# unchanged (jeeves #96780) from the #93569 causal-arm campaign's journal
# (prereg §6/§8; grade R1-F1/F3, R2-1/R2-11) for the #87588 coaching-minimum
# causal arm.
#
